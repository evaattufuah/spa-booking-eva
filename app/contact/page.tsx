    ...
    <div className="bg-gradient-to-r from-slate-900 to-slate-700 min-h-screen">
      ...
      <div className="min-h-screen bg-gradient-to-r from-sky-700 to-sky-500 py-12">
        ...
        <div className="text-white text-center mx-auto w-5/6 md:w-2/3 lg:w-1/2">
          ...
          <p className="mb-4"><strong>Email:</strong> For questions about our services, packages, or any special requests, email us at <a href="attufuahevabensa@gmail.com"className="text-lime-400 underline">attufuahevabensa@gmail.com </a> . We aim to respond within 24 hours. </p>
          <p className="mb-4">
          ...
          <p className="mt-8">
            <strong>Feedback:</strong> We value your feedback and suggestions.  Share your experience with us to help us improve our services. Email us at attufuahevabensanaomi@gmail or use our feedback form .
          </p>
        </div>
